...
void
igusa_I4_fmpz(fmpz_t res, const fmpz_t a0, const fmpz_t a1, const fmpz_t a2,
...
/* Init all power lists */
    a0_pows = _fmpz_vec_init(3);
    a1_pows = _fmpz_vec_init(3);
    a2_pows = _fmpz_vec_init(4);
    a3_pows = _fmpz_vec_init(3);
    a4_pows = _fmpz_vec_init(4);
    a5_pows = _fmpz_vec_init(3);
    a6_pows = _fmpz_vec_init(3);
...
/* Add successive terms to res */
    ...
    fmpz_mul_si(temp, temp, 1620);
    fmpz_add(res, res, temp);

/* Clear all power lists */
    _fmpz_vec_clear(a0_pows, 3);
    _fmpz_vec_clear(a1_pows, 3);
    _fmpz_vec_clear(a2_pows, 4);
    _fmpz_vec_clear(a3_pows, 3);
    _fmpz_vec_clear(a4_pows, 4);
    _fmpz_vec_clear(a5_pows, 3);
    _fmpz_vec_clear(a6_pows, 3);
